...
extension HasTrailingCodeBlock where Self: StmtSyntaxProtocol {
  public init(_ header: SyntaxNodeString, @CodeBlockItemListBuilder bodyBuilder: () throws -> CodeBlockItemListSyntax)
    throws
  {
...
extension VariableDeclSyntax {
  ...
  public init(_ header: SyntaxNodeString, @CodeBlockItemListBuilder accessor: () throws -> CodeBlockItemListSyntax)
    throws
  {
    let decl = DeclSyntax("\(header) {}")
    guard let castedDecl = decl.as(Self.self) else {
